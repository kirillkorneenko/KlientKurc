...
public class AddCargo extends javax.swing.JFrame {

    private User user;
    public AddCargo(User u) {
        user= u;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Добавление груза");
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 180, 180, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 259, 40));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 320, 259, 40));

        jLabel2.setFont(new java.awt.Font("Segoe Script", 1, 24)); // NOI18N
        jLabel2.setForeground(java.awt.Color.yellow);
        jLabel2.setText("Введите вес:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        cargo.setWeight(Float.parseFloat(jTextField1.getText()));
        cargo.setPrice(Float.parseFloat(jTextField3.getText()));
        cargo.setUserId(user.getId());
        Batch batch = new Batch(true,"INSERT_CARGO",null,cargo);
